    ...
    return (
        <>
            ...
            <div className="flex flex-wrap gap-2 my-1">
                ...
                <BaseButton
                    tooltipLabel="Download invoice PDF (English)"
                    onClick={() => downloadPdfInLanguage("English")}
                    size="sm"
                    variant={"outline"}
                >
                ...
                <BaseButton
                    tooltipLabel="Download invoice PDF (Serbian)"
                    onClick={() => downloadPdfInLanguage("Srpski")}
                    size="sm"
                    variant={"outline"}
                >
                    <DownloadCloudIcon className="w-5 h-5" />
