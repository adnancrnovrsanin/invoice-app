    ...
    return (
        <section className="flex flex-col gap-3">
            ...
            <FormInput
                ...
                label={_t("form.steps.fromAndTo.vatNumber")}
                placeholder="Tax ID / PIB"
            />
            <FormInput
                name="receiver.registrationNumber"
                label={_t("form.steps.fromAndTo.registrationNumber")}
                placeholder="Registration Number / MB"
            />
